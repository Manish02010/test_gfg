<h2><a href="https://www.geeksforgeeks.org/problems/last-coin-in-a-game-of-alternates/1?_gl=1*1jairg5*_up*MQ..&gclid=CjwKCAjw9anCBhAWEiwAqBJ-c9l6iN28H0hpX1nV9NJau6f2k838GOnG6STiKQX3_nr0iD3uFnvXWhoCEsIQAvD_BwE&gbraid=0AAAAAC9yBkCNzApP3nhhAPa6ZQq3u_vZR">Last Coin in a Game of Alternates</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p data-pm-slice="0 0 []"><span style="font-size: 18.6667px;">Given an array integer<strong> arr[]</strong> , representing the values of coins arranged in a row.</span></p>
<ul>
